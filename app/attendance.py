...
# Fixed offset, not a system/zoneinfo lookup — the host (e.g. a Railway
# container) runs in UTC regardless of where students actually are, and the
# session cutoff must follow India time, not the server's clock. India has
